...
用法
----
    python tools/migrate_quota_scope.py                # 只报告，不落盘（默认）
    python tools/migrate_quota_scope.py --apply        # 真迁移（自动备份）
    python tools/migrate_quota_scope.py --ledger <path> --results <path>
"""
